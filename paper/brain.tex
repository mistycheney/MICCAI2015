...
%
%
%Gabor filters are widely used to model textures since its use for texture segmentation in \cite{jain1990unsupervised}.
%
%Gaussian kernels modulated by a sinusoid function. The filters span a range of frequencies and 
%
%\cite{clausi2000designing} describes the optimal strategy for choosing the frequency spacing to minimize the redundancy.
%
...
%
%
%Other descriptors that are applied to histology images include local binary patterns, SIFT points, grey-level co-occurrence matrix, intensity histogram.
%
%
%\subsection*{Saliency and Objectness Detection}
%
%
%This idea is similar to bottom-up approaches for saliency detection.
%
...
%
%
%In \cite{gao2009decision}, uses hypothesis testing where the surround is modeled as null
